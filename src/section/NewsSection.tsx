      ...
      <Tabs defaultValue="news" className="mt-[40px]">
        <div className="flex items-baseline justify-between w-full">
          <TabsList className="flex gap-2.5">
            <TabsTrigger
              className=" rounded-[30px] text-[#394854] border border-[#39485426] text-[14px] font-medium py-[17px] px-[40px] h-[60px] hover:cursor-pointer hover:bg-[#d8d8d829] data-[state=active]:bg-[#0132C5]
                  ...
                  <Card className="relative bg-[#F8F8F9]  w-[100%] p-[34px] border-none rounded-t-none rounded-b-none overflow-hidden group">
                    ...
                    <div className="relative z-20 space-y-4 transition-colors duration-300 group-hover:text-white">
                      <h5 className="font-semibold leading-[25px] text-[18px]">
                        Xitoydan O‘zbekistonga yetkazib berishda yangi
                        yondashuvlar
                      </h5>
                      <p className="text-[18px]">
                        Xitoydan O‘zbekistonga kengaytirilgan xizmatlar taklif
                        etiladi. Endi siz faqat yuk tashish emas, balki
                        konsolidatsiya xizmati, bojxona rasmiylashtiruvi va
                        eshikkacha yetkazib berish kabi qo‘shimcha xizmatlardan
                    ...
                    <CardFooter className="pt-[36px] p-0 flex justify-between w-full border-t border-t-[#39485426] mt-[100px] relative z-20 transition-colors duration-300 group-hover:border-t-[#74899a]">
                      <strong className="font-medium text-[#0132C5] text-[86px] group-hover:text-white">
                        1{index}
                      </strong>
