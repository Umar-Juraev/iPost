...
const PartnersSection = () => {
  ...
  return (
      <div className='grid grid-cols-5 border-t border-b border-[#39485426]'>
  ...
  <h5 className="font-medium text-white text-[40px] z-10">Hamkorlar</h5>
          ...
          {logoBrands.map((image, index) =>
              <div key={index} className='flex items-center justify-center h-[384px] w-full border border-[#39485426] group '>
                    ...
                    <Image src={image} alt='Logo' className='w-[260px] h-[260px] object-contain grayscale duration-100 ease-in group-hover:grayscale-0'/>
                </div>
        )}
